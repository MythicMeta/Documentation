...
* [x] Solidified P2P spec - [Delegates](../customizing/payload-type-development/create\_tasking/agent-side-coding/delegates.md) and [P2P Connections](../customizing/hooking-features/linking-agents/action-p2p\_info.md)
